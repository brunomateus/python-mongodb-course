...
Week 1
----
Introduction: Overview, Design goals, the Mongo shell, JSON quick intro, installing
tools, overview of blog project. Bottle, Pymongo

Week 2 
----
Creating, Reading and Updating Data: Mongo shell, query operators, update operators
and a few commands.
